...
class DashBoardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const summaryCards = [
      SummaryCard(title: 'Total Points of Interest', value: '0'),
      SummaryCard(title: 'Total Users', value: '0'),
      SummaryCard(title: 'Total Events', value: '0'),
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: TableView.builder(
        columnCount: 5, //Inventory.itemCount,
        ...
        columnBuilder: (index) {
          return TableSpan(
            ...
            extent: const FractionalTableSpanExtent(2/12),
          );
        },
        rowBuilder: (index) {
          return TableSpan(
